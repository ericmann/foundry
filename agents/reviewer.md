...
model: fable
effort: high
tools: Read, Write, Edit, Bash, Grep, Glob, mcp__plugin_foundry_foundry__foundry_status, mcp__plugin_foundry_foundry__foundry_verify, mcp__plugin_foundry_foundry__foundry_review_submit
skills:
